  ...
  head: () => ({
    meta: [
      ...
      { title: "DK Agarbatti — Complete Pooja Products Store" },
      {
        name: "description",
        content:
          "Premium agarbatti, dhoop, brass pooja items and festival kits. DK Agarbatti — Maharashtra & Panjim, Goa.",
      },
      { name: "author", content: "DK Agarbatti" },
      { property: "og:site_name", content: "DK Agarbatti" },
